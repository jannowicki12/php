...
while ($res = mysqli_fetch_assoc($select)){
    ...
    if($res['rank'] == 2){
      ...
      echo '
        <div class="container">
        <div class="kategorie">
            <a href="AdminPanel.php?panel=users" style="text-decoration: none;"> <h3 style="color: blue;"> Users </h3></a>
            <a href="AdminPanel.php?panel=listtodo" style="text-decoration: none;"> <h3 style="color: red;"> List todo </h3></a>
            <a href="AdminPanel.php?panel=listorders" style="text-decoration: none;"> <h3 style="color: green;"> List Orders </h3></a>
        </div>
        <div class="tools">
        ';
